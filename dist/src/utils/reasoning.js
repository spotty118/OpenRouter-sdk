...
export class Reasoning {
     ...
     * ```
     */
    static setMaxTokens(maxTokens, exclude = false) {
        return {
     ...
     * ```
     */
    static highEffort(exclude = false) {
     ...
     * ```
     */
    static mediumEffort(exclude = false) {
     ...
     * ```
     */
    static lowEffort(exclude = false) {
     ...
     * ```
     */
    static fromLegacyParam(includeReasoning) {
