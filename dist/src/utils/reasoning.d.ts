...
export declare class Reasoning {
     ...
     * ```
     */
    static setEffort(level: 'high' | 'medium' | 'low', exclude?: boolean): ReasoningConfig;
    /**
     ...
     * ```
     */
    static setMaxTokens(maxTokens: number, exclude?: boolean): ReasoningConfig;
    /**
     ...
     * ```
     */
    static highEffort(exclude?: boolean): ReasoningConfig;
    /**
     ...
     * ```
     */
    static mediumEffort(exclude?: boolean): ReasoningConfig;
    /**
     ...
     * ```
     */
    static lowEffort(exclude?: boolean): ReasoningConfig;
    /**
