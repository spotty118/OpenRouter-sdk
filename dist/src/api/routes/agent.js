 ...
 */
router.post('/:agentId/knowledge/batch', async (req, res) => {
    try {
        const apiKey = req.app.locals.apiKey;
        const agentId = req.params.agentId;
 ...
 */
router.get('/:agentId/knowledge/search', async (req, res) => {
    try {
        const apiKey = req.app.locals.apiKey;
        const agentId = req.params.agentId;
 ...
 */
router.get('/:agentId/knowledge/:documentId', async (req, res) => {
    try {
        const apiKey = req.app.locals.apiKey;
        const agentId = req.params.agentId;
 ...
 */
router.delete('/:agentId/knowledge/:documentId', async (req, res) => {
    try {
        const apiKey = req.app.locals.apiKey;
        const agentId = req.params.agentId;
        const documentId = req.params.documentId;
