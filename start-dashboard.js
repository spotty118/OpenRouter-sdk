...
// Use dynamic import for 'open' since it might not be installed
let open;
try {
  const openModule = await import('open');
  open = openModule.default;
} catch (err) {
  console.log('Note: open package not found, browser will not open automatically');
  open = async () => {}; // Fallback empty function
}
